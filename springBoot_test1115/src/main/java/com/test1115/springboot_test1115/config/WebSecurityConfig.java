package com.test1115.springboot_test1115.config;

import com.test1115.springboot_test1115.filter.JwtAuthenticationFilter;
 ...
 * : Spring Security를 통해 웹 애플리케이션의 보안을 구성 ( 환경 설정 )
 * - JWT 필터를 적용하여 인증을 처리, CORS 및 CSRF 설정을 비활성화
 *   > 서버 간의 통신을 원활하게 처리
 * */
@Configuration // 해당 클래스가 Spring의 설정 클래스로 사용됨을 명시 ( 여기는 환경 설정이야 다~ 불러다 쓸 수 있어 )
@EnableWebSecurity // Spring Security의 웹 보안을 활성화 ( 해당 파일의 클래스의 설정 사항을 사용 할 수 있도록 활성화함 )
...
public class WebSecurityConfig {
     ...
     * - 비동기 통신을 하는 rest api 경우 사용자가 의도치 않게
     * - 악의적인 요청을 보내는 csrf 공격 보호를 비활성화한다.
     *
        ...
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers(
                                ...
                                new AntPathRequestMatcher("/api/v1/auth/**") // 얘만 남기만 로그인 된 사용자만 ~

//                                new AntPathRequestMatcher("/api/v1/menus/**") // 메뉴용
